...
export async function GET(request) {
  const projects = [
    ...
    {
      name: "Dropbear Programming Language",
      description:
        "A sophisticated Lisp-inspired programming language built from scratch in JavaScript with comprehensive language implementation features. Choose from built-in mathematical operations, string handling, and extensible function system with auto-compilation to JavaScript for universal runtime compatibility. Features advanced lexical analysis with maximal munch tokenization, recursive descent parsing, tree-walking interpretation, and an interactive REPL interface with seamless integration across any JavaScript environment.",
      stack: ["JavaScript"],
      link: "https://github.com/SaqAsh/dropbear",
    },
    {
      name: "Brawn",
      description:
